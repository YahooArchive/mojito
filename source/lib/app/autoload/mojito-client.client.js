...
YUI.add('mojito-client', function(Y, NAME) {
    ...
    function decompressBinders(config) {
        var YUI_PREFIX = '$x_',
            MOJITO_PREFIX = '$y_',
            MOJITO_STATIC_PREFIX = '/static/mojito/',
            yuiBase,
            yuiPrefix,
            mojitoPrefix,
            mojitoStaticPrefix,
        ...
        yuiPrefix = deployConfig.yuiPrefix || YUI_PREFIX;
        mojitoPrefix = deployConfig.mojitoPrefix || MOJITO_PREFIX;
        mojitoStaticPrefix = deployConfig.staticHandlingPrefix || MOJITO_STATIC_PREFIX;
