...
YUI.add('ReadController-tests', function(Y) {
    ...
    suite.add(new YUITest.TestCase({
        ...
        'sizing test 1': function() {
            A.areSame('xx-large', controller.size(100, 100));
        },

        'sizing test 2': function() {
            A.areSame('xx-large', controller.size(100, 160));
        },

        'sizing test 3': function() {
            A.areSame('x-large', controller.size(150, 100));
        },

        'sizing test 4': function() {
            A.areSame('xx-large', controller.size(71, 200));
        },

        'sizing test 5': function() {
            A.areSame('x-large', controller.size(71, 400));
        },

        'sizing test 6': function() {
            A.areSame('large', controller.size(71, 750));
        },

        'sizing test 6b': function() {
            A.areSame('large', controller.size(30, 750));
        },

        'sizing test 7': function() {
            A.areSame('medium', controller.size(1000, 100));
        },

        'sizing test 8': function() {
            A.areSame('medium', controller.size(1, 850));
        },
        ...
        'action test': function() {
            ...
            ac.done = function(data) {
                ...
                A.areSame('999', data.spaceid);
                A.areSame('999', data.stories.spaceid);
