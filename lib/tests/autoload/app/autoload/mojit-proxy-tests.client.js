...
YUI.add('mojito-mojit-proxy-tests', function(Y, NAME) {
    ...
    function fakeProxyOptions(o) {
        var strings = ['base', 'templateId', 'instanceId', 'templates', 'assetsRoot'],
            objs = ['templates', 'client', 'config', 'context'],
            out = {};
    ...
    suite.add(new YUITest.TestCase({
        ...
        'broadcast sends to all listeners': function() {
            ...
            mockClient.expect({
                method: 'doBroadcast',
                args: ['mojit:foo', 'templateId', 'payload']
            });
        ...
        'Test refreshTemplate function': function() {
