...
YUI.add('mojito-partial-addon-tests', function(Y, NAME) {
    ...
    suite.add(new YUITest.TestCase({
        ...
        'callback called with error when template is not found': function() {
            var ac = {},
                command = {
                    instance: {
                        templates: {}
        ...
        'correctly invokes named template engine': function() {
            var ac = {},
                data = { key: 'value' },
                command = {
                    instance: {
        ...
        'passes a valid adapter to the template engine': function() {
            var ac = {},
                command = {
                    instance: {
                        templates: {
