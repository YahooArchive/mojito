...
MojitoServer.prototype._useMiddleware = function (app, dispatcher, midDir, midConfig, middleware) {
    ...
    // TODO: document middleware API for app developers
    for (m = 0; m < middleware.length; m += 1) {
        ...
        if (0 === midName.indexOf('mojito-')) {
            ...
            if (midName === 'mojito-handler-dispatcher') {
                ...
                // Mojito can now register middleware by module name, or by
                // paths.
                // 
            ...
            // user-provided middleware is specified by path
            // app developers will most likely package their middlewares within
            // their app.
