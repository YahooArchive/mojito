...
**/
global.waterfall = new (require('mojito-waterfall').Waterfall)()

Mojito.prototype._init = function () {
waterfall.start('init');
    var app = this._app,
...
console.log(modules.length);
    Y.use.apply(Y, ['mojito', 'mojito-util', 'mojito-hooks', 'mojito-dispatcher', 'mojito-hb']);//modules);
