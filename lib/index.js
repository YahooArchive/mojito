...
MojitoServer.prototype = {
    ...
    addMojitoToExpressApp: function(app, options) {
        ...
        if (perfConfig) {
            ...
            // applying for all Y instance in case a mojit
            // that requires isolation is using perf.
            YUI.applyConfig({
                perf: perfConfig
            });
            // adding the perf to the mojito Y
            Y.applyConfig({
                perf: appConfig.perf
            });
        }
        ...
        // releasing the lock of useSync after getting the basic
        // stuff in place.
