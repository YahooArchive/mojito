...
YUI.add('mojito-resource-store', function(Y, NAME) {
    ...
    Y.extend(ResourceStore, Y.Base, {
        ...
        initializer: function(cfg) {
            ...
            this._fwConfig = this.config.readConfigThroughCacheSync(this._libs.path.join(this._config.mojitoRoot, 'config.json'));
        ...
        preloadResourceVersions: function() {
            ...
            if (!walkedMojito) {
                ...
                info.pkg = this.config.readConfigThroughCacheSync(this._libs.path.join(dir, 'package.json'));
        ...
        _preloadDirMojit: function(dir, dirType, pkg) {
            ...
            packageJson = this.config.readConfigThroughCacheSync(this._libs.path.join(dir, 'package.json'));
            if (packageJson) {
                if (packageJson.name) {
