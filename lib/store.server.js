...
YUI.add('mojito-resource-store', function(Y, NAME) {
    ...
    Y.extend(ResourceStore, Y.Base, {
        ...
        getAppConfig: function(ctx) {
            ...
            //NOTE: we may remove that and put it once in a good and nice place...
            ...
            //NOTE edge case, eventually we may remove this as well??
            // who use this? where is coming from?
            this.mergeRecursive(appConfig, this._config.appConfig);

            return (this._appConfigCache[key] = Object.freeze(appConfig));
        },
        /**
        ...
        expandInstanceForEnv: function(env, instance, ctx, cb) {
            ...
            // FIXME: remove copy op on return
            this._expandInstanceCache[env][cacheKey] = Y.mojito.util.deepFreeze(spec);
        ...
        getRoutes: function(ctx) {
            ...
            this._routesCache[key] = Object.freeze(out);
