...
function staticProvider(store, globalLogger) {
    ...
    function produceMeta(name, lang) {
        ...
        return MODULE_TEMPLATES[name]
            .replace('{app-base}', appMetaData.base[lang] ?
                appMetaData.base[lang] : appMetaData.base['*'])
            .replace('{app-full}', appMetaData.full[lang] ?
                appMetaData.full[lang] : appMetaData.full['*'])
            .replace('{yui-base}', yuiMetaData.base[lang] ?
                yuiMetaData.base[lang] : yuiMetaData.base['*'])
            .replace('{yui-full}', yuiMetaData.full[lang] ?
                yuiMetaData.full[lang] : yuiMetaData.full['*'])
