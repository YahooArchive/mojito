...
YUI.add('mojito-composite-addon', function(Y, NAME) {
    ...
    function AdapterBuffer(buffer, id, callback, hook_ctx) {
        ...
        Y.mojito.hooks.hook('adapterBuffer', hook_ctx, 'start', this);
        // HookSystem::EndBlock
    }
    ...
    AdapterBuffer.prototype = {
            ...
            // HookSystem::StartBlock
            Y.mojito.hooks.hook('adapterBuffer', this.__hook_ctx, 'end', this);
            // HookSystem::EndBlock
...
callback({
   ...
   assets: {}
        ...
        execute: function(cfg, cb) {
            ...
            // HookSystem::StartBlock
            Y.mojito.hooks.hook('addon', this.adapter.hook, 'start', self, cfg);
            // HookSystem::EndBlock
            ...
            this._dispatchChildren(cfg.children, this.command, buffer,
                function() {
                    ...
                    // HookSystem::StartBlock
                    Y.mojito.hooks.hook('addon', self.adapter.hook, 'end', self);
                    // HookSystem::EndBlock
