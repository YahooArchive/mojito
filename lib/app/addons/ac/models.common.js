...
YUI.add('mojito-models-addon', function (Y, NAME) {
    ...
    Addon.prototype = {
         ...
         * Gets model instance
         * @method get
         * @param {string} modelName The YUI module name of the model, or the model's
         * filename (minus the affinity and context parts). If the model's filename is given,
         * a contextualized version of the model will be returned.
        ...
        get: function (modelName) {
            ...
            var cache = this._page.models || {},
                ...
                yuiName = Y.mojito.models[modelName] ? modelName : this._instance.models[modelName];
