...
YUI.add('mojito-deploy-addon', function (Y, NAME) {
    ...
    Addon.prototype = {
        ...
        constructMojitoClientRuntime: function (assetHandler, binderMap) {
            ...
            yuiConfig       = store.yui.getYUIConfig();
            seedFiles       = store.yui.getAppSeedFiles(contextClient, yuiConfig);
            clientConfig.context = contextClient;

            // same as contextClient.lang to boot the app in the client
            // with the proper lang
            yuiConfig.lang = contextServer.lang;
