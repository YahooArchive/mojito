    ...
    Addon.prototype = {
        ...
        constructMojitoClientRuntime: function (assetHandler, binderMap) {
            ...
            var store = this.rs,
                ...
                pageAnnotations = this.adapter && this.adapter.page && this.adapter.page.annotations;
            ...
            clientConfig.annotations = pageAnnotations;
            clientConfig.page = {
            ...
            yuiConfigStr = serialize(yuiConfigEscaped);
            clientConfigEscaped = Y.mojito.util.cleanse(clientConfig);
            clientConfigStr = serialize(clientConfigEscaped);
