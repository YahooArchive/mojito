    ...
    Addon.prototype = {
        ...
        constructMojitoClientRuntime: function(assetHandler, binderMap) {
            ...
            yuiConfig = Y.merge({
                ...
                seed: "/static/combo?yui-base.js&loader-base.js&loader.js&" +
                    "loader-yui3.js&loader-app-base{langToken}.js"
            ...
            yuiConfig.seed = yuiConfig.seed.replace(REGEX_LANG_TOKEN,
