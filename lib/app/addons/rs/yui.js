    ...
    Y.extend(RSAddonYUI, Y.Plugin.Base, {
        ...
        getMojitModulesConfig: function (mojit, modules, env, justApp, lang) {
            ...
            for (r = 0; r < ress.length; r += 1) {
                ...
                if (lang !== undefined && res.type === 'yui-lang' && res.yui.lang !== lang) {
                    continue;
                }
        ...
        parseResourceVersion: function(source, type, subtype, mojitType) {
            ...
            if ('yui-lang' === type) {
                ...
                m = source.fs.basename.match(REGEX_LOCALE);
                res.yui.lang = m && m[1] || '';
         ...
         * @return {nothing}
         */
        makeResourceVersions: function(lang) {
            ...
            for (l = 0; l < langs.length; l += 1) {
                ...
                if (this._loaderCreated[lang]) {
                    continue;
                } else {
                    this._loaderCreated[lang] = true;
                }
...
// TODO just do store._mojitRV
// TODO could filter by affinity client and yui name
