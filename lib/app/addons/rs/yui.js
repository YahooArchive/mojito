    ...
    Y.extend(RSAddonYUI, Y.Plugin.Base, {
        ...
        parseResourceVersion: function(source, type, subtype, mojitType) {
            ...
            if ('yui-lang' === type) {
                ...
                res.yui.lang = (m && m[1]) || '';
                langExt = (res.yui.lang ? '_' + res.yui.lang : '');
                langFor = source.fs.basename.substring(0, source.fs.basename.length - langExt.length);
                res.yui.name = 'lang/' + langFor + langExt;
