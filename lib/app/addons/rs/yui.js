...
YUI.add('addon-rs-yui', function(Y, NAME) {
    ...
    Y.extend(RSAddonYUI, Y.Plugin.Base, {
        ...
        /**
         * Called by the ResourceStore to ask this addon to load its state from the cache.
         * @method resoruceCacheLoad
         * @param {object} cache The cache object from which the state should be loaded.
         * @return {nothing} Nothing particular should be returned.
         */
        resourceCacheLoad: function(cache) {
            this.langs          = cache.langs;
            this.resContents    = cache.resContents;
            this.appModulesRess = cache.appModulesRess;
            this.yuiModulesRess = cache.yuiModulesRess;
        },


        /**
         * Called by the ResourceStore to ask this addon to save its state into the cache.
         * @method resoruceCacheSave
         * @param {object} cache The cache object to which the state should be saved.
         * @return {nothing} Nothing particular should be returned.
         */
        resourceCacheSave: function(cache) {
            cache.langs         = this.langs;
            cache.resContents   = this.resContents;
            cache.appModulesRess = this.appModulesRess;
            cache.yuiModulesRess = this.yuiModulesRess;
        },
