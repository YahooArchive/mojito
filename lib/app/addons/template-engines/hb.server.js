...
YUI.add('mojito-hb', function(Y, NAME) {
     ...
     * @private
     */
    function HandleBarsAdapter(templateId) {
        ...
        render: function (data, mojitType, tmpl, adapter, meta, more) {
            var handler = function (err, obj) {
                ...
                if (obj) {
                    ...
                    Y.log('render complete for template "' +
                        tmpl + '"',
                        'mojito', 'qeperf');
                }
            ...
            this._getTemplateObj(tmpl, !meta.template.cacheTemplates, handler);
        },
    ...
    Y.namespace('mojito.addons.templateEngines').hb = HandleBarsAdapter;
