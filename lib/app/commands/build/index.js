 ...
 * destination dir, then invokes subcommand html5app.js or hybridapp.js or rescache.js.
 * @method run
...
function run(args, opts, cb) {
    ...
    switch (buildtype) {
    case 'rescache':
        // We don't want to use the cache because we want to do a real load so that we can
        // cache those results (instead of caching the results of the old cache).
        storeOptions.skipCache = true;
        break;
    case 'html5app':
        break;
    case 'hybridapp':
    ...
    // init resource store
    store = Store.createStore(storeOptions);
...
module.exports = {
    ...
    usage: [
        ...
        '',
        'type: "html5app" or "hybridapp" or "rescache"',
