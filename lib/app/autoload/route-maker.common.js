...
YUI.add('mojito-route-maker', function (Y, NAME) {
    ...
    var CACHE = { routes: {} }; // cache for _routes
    ...
    **/
    function buildRoute(name, route) {
        ...
        if (route.verbs.length && route.path && route.call) {
            ...
            if (typeof route.params !== 'object') {
                Y.log('** Deprecated ** params: "name=Tom&age=23" is no longer supported', 'warn', NAME);
    ...
    Maker.prototype = {
        ...
        /**
         * Expand the route data, and return a copy to preserve the original.
         *
         * NOTE: Not sure why these regex replacements ??!
         *
         * @method expand
         * @param {String} url the URL to find a route for.
         * @param {String} verb the HTTP method.
         * @param {Object} route
         * @return {Object} a copy of expanded `route`
         */
        // expand: function (uri, verb, route) {
        ...
        //     expanded = doCallReplacement(Y.mojito.util.copy(route), uri);
        //     if (!expanded) {
        //         return null;
        //     }
        ...
        //     ret = new RegExp(expanded.ext_match).exec(uri);
        //     i = 1;
