...
YUI.add('mojito-resource-store', function(Y, NAME) {
    ...
    Y.extend(ResourceStore, Y.Base, {
        ...
        resolveVersion: function (type, env, posl) {
            ...
            if (type === 'shared') {
                this._mojitDetailsCache[type + poslString + env] = Y.Object.values(resolvedResources);
            ...
            result = this.resolveMojitDetails(env, posl, type, Y.Object.values(resolvedResources).concat(sharedResources), mojitRes);
