...
YUI.add('mojito-resource-store', function(Y, NAME) {
    ...
    Y.extend(ResourceStore, Y.Base, {
        ...
        initializer: function(cfg) {
            ...
            this._routesCache = {}; // serialized route
        ...
        /**
         * NOTE:
         * 1. Routes are no longer contextualized
         * 2. Routing on the server is done the express way, and the submodule
         *    lib/router.js loads and registers the routes in `routes.json`.
         *    This method `getRoutes` is no longer used in server runtime.
         *
         * This method is preserved as the client runtime still needs to routes
         * for tunnel calls.
         *
         * TODO: remove the client dependency on this method
         *
