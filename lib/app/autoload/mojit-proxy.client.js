...
YUI.add('mojito-mojit-proxy', function(Y, NAME) {
    ...
    MojitProxy.prototype = {
         ...
         *      broadcast, use:
         *          {target: {slot: 'slot name', templateId: 'DOM template id'}}.
         */
        ...
        listen: function(name, callback) {
            this._client.doListen(MJT_EVT_PRFX + name, this._templateId,
                function(evt) {
        ...
        unlisten: function(name) {
            ...
            this._client.doUnlisten(this._templateId, eventName);
        },
        ...
        render: function(data, template, cb) {
            this._client.doRender(this, data, template, cb);
        },
        ...
        /**
         * Refreshes the current DOM template for this binder without recreating the
         * binder instance. Will call the binder's onRefreshTemplate() function when
         ...
         * @param {Function} cb Called after replacement and onRefreshTemplate have
         *     been called, sends data/meta.
         */
        refreshTemplate: function(opts, cb) {
            opts = opts || {};
            if (Y.Lang.isFunction(opts)) {
                cb = opts;
                opts = {};
            }
            this._client.refreshMojitTemplate(this, opts, cb);
        },
        ...
        /**
         * Clears out a child's template, calling the appropriate life cycle
        ...
        _destroy: function(retainNode) {
            ...
            Y.log('destroying binder ' + this._templateId, 'debug', NAME);
            ...
            this._client.doUnlisten(this._templateId);
        },
