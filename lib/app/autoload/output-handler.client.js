...
YUI.add('mojito-output-handler', function(Y, NAME) {
     ...
     * @param {string} templateId An optional template ID for the mojit.
     * @param {Function} callback The callback function to invoke.
     */
    complete = function(data, meta, client, templateId, callback) {
        ...
        if (meta && meta.binders) {
            ...
            window.setTimeout(function() {
                client.attachBinders(meta.binders, templateId, meta.template.id);
            });
        }
    };
     ...
     * @class OutputHandler
     * @constructor
     * @param {String} templateId The template id of the current mojit binder
     *     responsible for this action execution
     * @param {Function} cb
     * @param {Object} mojitoClient
     */
    function OutputHandler(templateId, cb, mojitoClient) {
        ...
        flush: function(data, meta) {
            ...
            if (meta && meta.assets) {
                attachAssets(meta.assets, function() {
                    complete(data, meta, client, templateId, callback);
                });
            } else {
                complete(data, meta, client, templateId, callback);
            }
