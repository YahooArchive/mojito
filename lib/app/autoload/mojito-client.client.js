...
YUI.add('mojito-client', function(Y, NAME) {
    ...
    MojitoClient.prototype = {
        ...
        init: function(config) {
            ...
            Y.mojito.hooks.hook('mojitoClient', Y.mojito.hooks.client_ctx, 'start', this);
            // HookSystem::EndBlock
            var that = this,
            ...
            // HookSystem::StartBlock
            Y.mojito.hooks.hook('mojitoClient', Y.mojito.hooks.client_ctx, 'end', this);
            // HookSystem::EndBlock
        ...
        attachBinders: function(binderMap, parentId, topLevelMojitViewId) {
            ...
            // HookSystem::StartBlock
            Y.mojito.hooks.hook('mojitoClientBind', Y.mojito.hooks.client_ctx, 'start', this);
            // HookSystem::EndBlock

            if (!totalBinders) {
                // HookSystem::StartBlock
                Y.mojito.hooks.hook('mojitoClientBind', Y.mojito.hooks.client_ctx, 'resume', this);
                // HookSystem::EndBlock
                me.resume();
                // HookSystem::StartBlock
                Y.mojito.hooks.hook('mojitoClientBind', Y.mojito.hooks.client_ctx, 'end', this);
                // HookSystem::EndBlock
            ...
            onBinderComplete = function() {
                ...
                // HookSystem::StartBlock
                Y.mojito.hooks.hook('mojitoClientBindComplete', Y.mojito.hooks.client_ctx, 'start', this);
                // HookSystem::EndBlock
                me.resume();
                // HookSystem::StartBlock
                Y.mojito.hooks.hook('mojitoClientBindComplete', Y.mojito.hooks.client_ctx, 'end', this);
                // HookSystem::EndBlock
                fireLifecycle('post-attach-binders', {});
            };
