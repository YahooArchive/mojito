        ...
        executeAction: function(command, viewId, cb) {
            ...
            this.resourceStore.expandInstanceForEnv('client',
                command.instance, this.context, function(err, details) {
                    ...
                    var controllerModule = details && details.controller,
                        ...
                        engine = (details && details.views && details.views[command.action] &&
                            details.views[command.action].engine) || 'hb';
